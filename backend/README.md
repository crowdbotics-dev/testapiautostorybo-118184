...
## Project Structure
    ...
    ├── testapiautostorybo_118184  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_118184`
...
2. Clone this repo and `cd testapiautostorybo_118184`
